...
public class LeverSwapP2Sprites : MonoBehaviour {
	...
	void Start () {
		...
		GameObject p1_1_points = PhotonNetwork.Instantiate("p1_1_points", q, Quaternion.identity, 0);
...
//Find what I wanna destroy
	...
	void Player2View(){
		...
		GameObject p2_1_points = PhotonNetwork.Instantiate("p2_1_points", Vector3.zero, Quaternion.identity, 0);
